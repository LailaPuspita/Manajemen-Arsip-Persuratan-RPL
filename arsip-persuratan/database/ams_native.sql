...
(1, 'Pembina Perguruan Tinggi Pangkal Perjuangan', 'Universitas Singaperbangsa Karawang', 'Terakreditasi B', 'Jl. HS.Ronggo Waluyo, Puseurjaya, Telukjambe Timur, Karawang, Jawa Barat 41361', 'Dr. Mayasari, SS., M.Hum', '-', 'https://unsika.ac.id/', 'info@unsika.ac.id', 'logo unsika.png', 1);
